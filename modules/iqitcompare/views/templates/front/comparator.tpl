...
{block name='page_content'}
    <h1>{l s='Products compare' mod='iqitcompare'}</h1>
                            ...
                            <tr>
                                ...
                                {foreach from=$compareProducts item="product"}
                                    ...
                                    {if isset($listFeatures[$product_id])}
                                        ...
                                        <td class="{$classname} iqitcompare-feature-td js-iqitcompare-product-{$product.id_product}">{if (isset($tab[$feature_id]))}{$tab[$feature_id]}{/if}</td>
                                    {else}
