...
class IqitHtmlAndBannerRepository
{
    ...
    {
        $usableHooks = ['displayFooter', 'displayLeftColumn', 'displayRightColumn', 'displayReassurance', 'displayRightColumnProduct', 'displayNav1', 'displayNav2'];
    ...
    {
        $usableHooks = ['displayFooter', 'displayLeftColumn', 'displayRightColumn', 'displayReassurance', 'displayRightColumnProduct', 'displayBanner'];
