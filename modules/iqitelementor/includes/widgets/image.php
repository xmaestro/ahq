...
class Widget_Image extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'placeholder' => \IqitElementorWpHelper::__( 'Enter your caption about the image', 'elementor' ),
                'title' => \IqitElementorWpHelper::__( 'Input image caption here', 'elementor' ),
                'section' => 'section_image',
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        $image_html .= sprintf( '<img src="%s" title="%s" alt="%s"%s />', \IqitElementorWpHelper::esc_attr( $instance['image']['url'] ), Control_Media::get_image_title( $instance['image'] ), Control_Media::get_image_alt( $instance['image'] ), $image_class_html );
