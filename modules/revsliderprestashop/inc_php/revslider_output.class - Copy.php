...
//					else{
//						global $post;
//                                        if(@RevsliderPrestashop::getIsset($post->ID)){
...
//					}
        ...
        foreach ($slides as $slide) {
            ...
            if ($isExternal != 'external') {
                ...
                /* $img_w = '';
                  ...
                  if($img_size !== 'full'){
                  if(@RevsliderPrestashop::getIsset($img_data['sizes']) && @RevsliderPrestashop::getIsset($img_data['sizes'][$img_size])){
                  $img_w = (@RevsliderPrestashop::getIsset($img_data['sizes'][$img_size]['width'])) ? $img_data['sizes'][$img_size]['width'] : '';
                  $img_h = (@RevsliderPrestashop::getIsset($img_data['sizes'][$img_size]['height'])) ? $img_data['sizes'][$img_size]['height'] : '';
                  }
                  }

                  if($img_w == '' || $img_h == ''){
                  $img_w = (@RevsliderPrestashop::getIsset($img_data['width'])) ? $img_data['width'] : '';
                  $img_h = (@RevsliderPrestashop::getIsset($img_data['height'])) ? $img_data['height'] : '';
                  }
            ...
            if (@RevsliderPrestashop::getIsset($slide->ignore_alt)) {
                $alt = '';
            }
            ...
            if ($isThumbsActive == true || $is_special_nav == true) {
                ...
                if ($thumb_do == 'slider') { //use the slider settings for width / height
                    $th_width = (int) ($this->slider->getParam('previewimage_width', $this->slider->getParam('thumb_width', 100)));
                    $th_height = (int) ($this->slider->getParam('previewimage_height', $this->slider->getParam('thumb_height', 50)));

                    //$th_width = (int)($this->slider->getParam('thumb_width', 100));
                    //$th_height = (int)($this->slider->getParam('thumb_height', 50));
                    if ($th_width == 0) {
                        $th_width = 100;
                    }
                    if ($th_height == 0) {
            ...
            $styleImage = '';
            $urlImageTransparent = _MODULE_DIR_ . 'revsliderprestashop/views/img/images/transparent.png';
            ...
            $bgPositionX = (int) ($slide->getParam('bg_position_x', $this->slider->getParam('def-bg_position_x', '0')));
            $bgPositionY = (int) ($slide->getParam('bg_position_y', $this->slider->getParam('def-bg_position_y', '0')));
            ...
            if ($post_based_slider) {
                ...
                $slide_description = ' data-description="' . str_replace(array("\'", '\"'), array("'", '"'), ($slide->getParam('slide_description', ''))) . '"';
            } else {
                $slide_title = ' data-title="' . Tools::stripslashes(($slide->getParam("title", "Slide"))) . '"';
                $slide_description = ' data-description="' . str_replace(array("\'", '\"'), array("'", '"'), ($slide->getParam('slide_description', ''))) . '"';
            }
    ...
    public function putBackgroundVideo($slide)
    {
        ...
        if ($adv_resp_sizes == true) {
            if (is_object($videoWidth)) {
                $videoWidth = RevSliderFunctions::normalizeDeviceSettings($videoWidth, $enabled_sizes, 'html-array');
            }
            if (is_object($videoHeight)) {
                $videoHeight = RevSliderFunctions::normalizeDeviceSettings($videoHeight, $enabled_sizes, 'html-array');
            }
        } else {
            if (is_object($videoWidth)) {
                $videoWidth = RevSliderFunctions::getBiggestDeviceSetting($videoWidth, $enabled_sizes);
            }
            if (is_object($videoHeight)) {
                $videoHeight = RevSliderFunctions::getBiggestDeviceSetting($videoHeight, $enabled_sizes);
            }
        }
        ...
        if ($video_added == false) {
            return false;
        } // return here if no valid video was found.
    ...
    {
//        return "style='font-family:{$this->sds_rev_layer_font}; ";
    ...
    private function putCreativeLayer(RevSlide $slide, $static_slide = false)
    {
        ...
        $icon_sets = RevSliderBase::setIconSets(array());
        ...
        foreach ($layers as $layer) {
            ...
            if (trim($class) !== '') {
                ...
                if (!@RevsliderPrestashop::getIsset($in_class_usage[trim($class)])) {
            ...
            if ($do_remove_inline) {
                if (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]) && @RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params'])) {
                    //defaults get set here

                    $dfos = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'font-size'})) ? $in_class_usage[trim($class)]['params']->{'font-size'} : $dfos;
                    $dlh = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'line-height'})) ? $in_class_usage[trim($class)]['params']->{'line-height'} : $dlh;
                    $dfw = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'font-weight'})) ? $in_class_usage[trim($class)]['params']->{'font-weight'} : $dfw;

                    $dco = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'color'})) ? $in_class_usage[trim($class)]['params']->{'color'} : $dco;
                    $dcot = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'color-transparency'})) ? $in_class_usage[trim($class)]['params']->{'color-transparency'} : $dcot;
                    $dbc = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'background-color'})) ? $in_class_usage[trim($class)]['params']->{'background-color'} : $dbc;
                    $dbt = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'background-transparency'})) ? $in_class_usage[trim($class)]['params']->{'background-transparency'} : $dbt;
                    $dboc = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'border-color'})) ? $in_class_usage[trim($class)]['params']->{'border-color'} : $dboc;
                    $dbot = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'border-transparency'})) ? $in_class_usage[trim($class)]['params']->{'border-transparency'} : $dbot;


                    $dff = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'font-family'})) ? $in_class_usage[trim($class)]['params']->{'font-family'} : $dff;
                    $dta = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'text-align'})) ? $in_class_usage[trim($class)]['params']->{'text-align'} : $dta;
                    $dfs = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'font-styles'})) ? $in_class_usage[trim($class)]['params']->{'font-styles'} : $dfs;
                    $dtd = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'text-decoration'})) ? $in_class_usage[trim($class)]['params']->{'text-decoration'} : $dtd;
                    $dpa = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'padding'})) ? $in_class_usage[trim($class)]['params']->{'padding'} : $dpa;
                    if (is_array($dpa)) {
                        $dpa = implode(' ', $dpa);
                    }
                    $dbs = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'border-style'})) ? $in_class_usage[trim($class)]['params']->{'border-style'} : $dbs;
                    $dbw = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'border-width'})) ? $in_class_usage[trim($class)]['params']->{'border-width'} : $dbw;
                    $dbr = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'border-radius'})) ? $in_class_usage[trim($class)]['params']->{'border-radius'} : $dbr;
                    if (is_array($dbr)) {
                        $dbr = implode(' ', $dbr);
                    }
                    $dc = (@RevsliderPrestashop::getIsset($in_class_usage[trim($class)]['params']->{'css_cursor'})) ? $in_class_usage[trim($class)]['params']->{'css_cursor'} : $dc;
                }
            }
            ...
            $layer_2d_rotation = (int) (RevSliderFunctions::getVal($layer, '2d_rotation', '0'));
            ...
            $elementdelay = (int) (RevSliderFunctions::getVal($layer, 'splitdelay', 0));
            $endelementdelay = (int) (RevSliderFunctions::getVal($layer, 'endsplitdelay', 0));
...
//            $this->sds_rev_layer_font = RevSliderFunctions::getVal($def_val, 'font-family', '');
//            if($this->sds_rev_layer_font){
//                $this->sds_rev_layer_font = str_replace("'", '"', $this->sds_rev_layer_font);
//                $text = preg_replace_callback('/style=\' /', array($this, 'sdsPutLayerFont'), $text);
//            }
...
//				}
            ...
            switch ($type) {
                ...
                case 'button':
                    ...
                    $max_width = (is_object($max_width)) ? RevSliderFunctions::getBiggestDeviceSetting($max_width, $enabled_sizes) : $max_width;
                    $max_height = (is_object($max_height)) ? RevSliderFunctions::getBiggestDeviceSetting($max_height, $enabled_sizes) : $max_height;
                    $white_space = (is_object($white_space)) ? RevSliderFunctions::getBiggestDeviceSetting($white_space, $enabled_sizes) : $white_space;

                    if ($max_width !== 'auto') {
                        $max_width = ($max_width !== 'none') ? RevSliderFunctions::addMissingVal($max_width) : $max_width;
                        $inline_styles .= ' min-width: ' . $max_width . '; max-width: ' . $max_width . ';';
                    }
                    if ($max_height !== 'auto') {
                        $max_height = ($max_height !== 'none') ? RevSliderFunctions::addMissingVal($max_height) : $max_height;
                    ...
                    if (!empty($static_styles)) {
                        ...
                        if (!empty($static_styles['font-size'])) {
                            $static_styles['font-size'] = RevSliderFunctions::addMissingVal($static_styles['font-size'], 'px');
                            if (is_object($static_styles['font-size'])) {
                                $mcfs = RevSliderFunctions::getBiggestDeviceSetting($static_styles['font-size'], $enabled_sizes);
                            } else {
                        ...
                        if (!empty($static_styles['line-height'])) {
                            $static_styles['line-height'] = RevSliderFunctions::addMissingVal($static_styles['line-height'], 'px');
                            if (is_object($static_styles['line-height'])) {
                                $mclh = RevSliderFunctions::getBiggestDeviceSetting($static_styles['line-height'], $enabled_sizes);
                            } else {
                        ...
                        if (!empty($static_styles['font-weight'])) {
                            if (is_object($static_styles['font-weight'])) {
                                $mcfw = RevSliderFunctions::getBiggestDeviceSetting($static_styles['font-weight'], $enabled_sizes);
                            } else {
                        ...
                        if (!empty($static_styles['color'])) {
                            if (is_object($static_styles['color'])) {
                                $use_color = RevSliderFunctions::getBiggestDeviceSetting($static_styles['color'], $enabled_sizes);
                            } else {
                ...
                case 'image':
                    ...
                    $cur_img_id = get_image_id_by_url($urlImage);
                    ...
                    if ($adv_resp_sizes == true) {
                        ...
                        if ($scaleX !== '') {
                            if (!is_object($scaleX)) {
                                ...
                                $myScaleX = RevSliderFunctions::normalizeDeviceSettings($scaleX, $enabled_sizes, 'html-array', array('NaNpx' => '', 'auto' => ''));
                                if ($myScaleX == "['','','','']") {
                                    $myScaleX = '';
                                }
                            ...
                            if ($y_is_single) { //force to array if voffset is also array
                                if (!@RevsliderPrestashop::getIsset($myScaleX)) {
                                    $myScaleX = RevSliderFunctions::getBiggestDeviceSetting($scaleX, $enabled_sizes);
                                }
                        ...
                        if ($scaleY !== '') {
                            if (!is_object($scaleY)) {
                                ...
                                $myScaleY = RevSliderFunctions::normalizeDeviceSettings($scaleY, $enabled_sizes, 'html-array', array('NaNpx' => '', 'auto' => ''));
                                if ($myScaleY == "['','','','']") {
                                    $myScaleY = '';
                                }
                            ...
                            if ($y_is_single) { //force to array if voffset is also array
                                if (!@RevsliderPrestashop::getIsset($myScaleY)) {
                                    $myScaleY = RevSliderFunctions::getBiggestDeviceSetting($scaleY, $enabled_sizes);
                                }
                        ...
                        $myScaleX = (is_object($scaleX)) ? RevSliderFunctions::getBiggestDeviceSetting($scaleX, $enabled_sizes) : $scaleX;
                        if (trim($myScaleX) == '' || $myScaleX == 'NaNpx') {
                            $myScaleX = 'auto';
                        }

                        $myScaleY = (is_object($scaleY)) ? RevSliderFunctions::getBiggestDeviceSetting($scaleY, $enabled_sizes) : $scaleY;
                ...
                case 'video':
                    ...
                    $only_poster_on_mobile = (@RevsliderPrestashop::getIsset($layer['video_data']->use_poster_on_mobile)) ? $layer['video_data']->use_poster_on_mobile : '';
                    ...
                    $videoThumbnail = (@RevsliderPrestashop::getIsset($videoData["previewimage"])) ? $videoData["previewimage"] : '';
                    if (is_ssl()) {
            ...
            if ($adv_resp_sizes == true) {
                ...
                $myLeft = RevSliderFunctions::normalizeDeviceSettings($left, $enabled_sizes, 'html-array');
                ...
                $myTop = RevSliderFunctions::normalizeDeviceSettings($top, $enabled_sizes, 'html-array');
                ...
                $myHor = RevSliderFunctions::normalizeDeviceSettings($alignHor, $enabled_sizes, 'html-array');
                ...
                $myVer = RevSliderFunctions::normalizeDeviceSettings($alignVert, $enabled_sizes, 'html-array');
                ...
                if (!empty($static_styles)) {
                    ...
                    if (!empty($static_styles['font-size'])) {
                        if (is_object($static_styles['font-size'])) {
                            $ss_fs = RevSliderFunctions::normalizeDeviceSettings($static_styles['font-size'], $enabled_sizes, 'html-array');
                    ...
                    if (!empty($static_styles['line-height'])) {
                        if (is_object($static_styles['line-height'])) {
                            $ss_lh = RevSliderFunctions::normalizeDeviceSettings($static_styles['line-height'], $enabled_sizes, 'html-array');
                    ...
                    if (!empty($static_styles['font-weight'])) {
                        if (is_object($static_styles['font-weight'])) {
                            $ss_fw = RevSliderFunctions::normalizeDeviceSettings($static_styles['font-weight'], $enabled_sizes, 'html-array');
                    ...
                    if (!empty($static_styles['color'])) {
                        if (is_object($static_styles['color'])) {
                            ...
                            $ss_c = RevSliderFunctions::normalizeDeviceSettings($static_styles['color'], $enabled_sizes, 'html-array');
                ...
                if (is_object($max_width)) {
                    $max_width = RevSliderFunctions::normalizeDeviceSettings($max_width, $enabled_sizes);
                ...
                if (is_object($max_height)) {
                    $max_height = RevSliderFunctions::normalizeDeviceSettings($max_height, $enabled_sizes);
                ...
                $white_space = RevSliderFunctions::normalizeDeviceSettings($white_space, $enabled_sizes);
                ...
                if (is_object($alignHor)) {
                    $alignHor = RevSliderFunctions::getBiggestDeviceSetting($alignHor, $enabled_sizes);
                }
                if (is_object($alignVert)) {
                    $alignVert = RevSliderFunctions::getBiggestDeviceSetting($alignVert, $enabled_sizes);
                }
                if (is_object($left)) {
                    $left = RevSliderFunctions::getBiggestDeviceSetting($left, $enabled_sizes);
                }
                if (is_object($top)) {
                    $top = RevSliderFunctions::getBiggestDeviceSetting($top, $enabled_sizes);
                }
            ...
            $bdw = RevSliderFunctions::addMissingVal($bdw, 'px');
            if ($bdw == '0px') {
            ...
            if (@RevsliderPrestashop::getIsset($adv_style['idle'])) {
            ...
            //Advanced Styles here:
            if (@RevsliderPrestashop::getIsset($il_style['idle'])) {
            ...
            if ($is_hover_active) {
                ...
                $st_hover['bw'] = array(RevSliderFunctions::addMissingVal(RevSliderFunctions::getVal($def_val, 'border-width', '0px'), 'px'), '0px');
                ...
                foreach ($st_hover as $sk => $sv) { //do not write values for hover if idle is the same value
                    if (@RevsliderPrestashop::getIsset($st_idle[$st_trans[$sk]]) && $st_idle[$st_trans[$sk]][0] == $sv[0]) {
                        unset($st_hover[$sk]);
                    }
                }
                ...
                //Advanced Styles here:
                if (@RevsliderPrestashop::getIsset($adv_style['hover'])) {
                ...
                //Advanced Styles here:
                if (@RevsliderPrestashop::getIsset($il_style['hover'])) {
                ...
                foreach ($a_action as $num => $action) {
                    ...
                    switch ($action) {
                        ...
                        case 'link':
                            ...
                            if (@RevsliderPrestashop::getIsset($a_link_type[$num]) && $a_link_type[$num] == 'jquery') {
                                /*
                                  $setBase = (is_ssl()) ? "https://" : "http://";
                                  if(strpos($a_image_link[$num], 'http') === false)
                                  $a_image_link[$num] = $setBase .$a_image_link[$num];
                                 */
                                $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                                $a_link_open_in[$num] = (@RevsliderPrestashop::getIsset($a_link_open_in[$num])) ? $a_link_open_in[$num] : '';
                                $a_image_link[$num] = (@RevsliderPrestashop::getIsset($a_image_link[$num])) ? $a_image_link[$num] : '';
                        ...
                        case 'jumpto':
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                            $a_jump_to_slide[$num] = (@RevsliderPrestashop::getIsset($a_jump_to_slide[$num])) ? $a_jump_to_slide[$num] : '';
                            $a_action_delay[$num] = (@RevsliderPrestashop::getIsset($a_action_delay[$num])) ? $a_action_delay[$num] : '';
                        ...
                        case 'callback':
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                            $a_actioncallback[$num] = (@RevsliderPrestashop::getIsset($a_actioncallback[$num])) ? $a_actioncallback[$num] : '';
                        ...
                        case 'scroll_under': //ok
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                            $a_scrolloffset[$num] = (@RevsliderPrestashop::getIsset($a_scrolloffset[$num])) ? $a_scrolloffset[$num] : '';

                            $a_events[] = array(
                                'event' => $a_tooltip_event[$num],
                                'action' => 'scrollbelow',
                                'offset' => RevSliderFunctions::addMissingVal($a_scrolloffset[$num], 'px')
                            );
                            break;
                        case 'start_in':
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                        ...
                        case 'toggle_layer':
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                            $a_toggle_layer_type[$num] = (@RevsliderPrestashop::getIsset($a_toggle_layer_type[$num])) ? $a_toggle_layer_type[$num] : '';
                            $a_action_delay[$num] = (@RevsliderPrestashop::getIsset($a_action_delay[$num])) ? $a_action_delay[$num] : '';
                        ...
                        case 'toggle_class':
                            $a_tooltip_event[$num] = (@RevsliderPrestashop::getIsset($a_tooltip_event[$num])) ? $a_tooltip_event[$num] : '';
                            $a_action_delay[$num] = (@RevsliderPrestashop::getIsset($a_action_delay[$num])) ? $a_action_delay[$num] : '';
                            $a_toggle_class[$num] = (@RevsliderPrestashop::getIsset($a_toggle_class[$num])) ? $a_toggle_class[$num] : '';
            ...
            if ($static_slide) {
                if ($isTemplate != "true" && $slider_type !== 'hero') {
                    $start_on_slide = (int) (RevSliderFunctions::getVal($layer, "static_start", 1)) - 1;
    ...
    public function addInlineStyles()
    {
        ...
        foreach ($styles as $key => $style) {
            ...
            if (!@RevsliderPrestashop::getIsset($this->class_include[$handle])) {
                unset($styles[$key]);
            }
        }
    ...
    public function putErrorMessage($message)
    {
        ...
        _e("Revolution Slider Error", REVSLIDER_TEXTDOMAIN);
        echo ': ' . $message;
    ...
    {
        try {
            $slver = RevSliderGlobals::SLIDER_REVISION;
            ...
            /* if($this->slider->getParam("js_to_body","false") == "true"){
              ...
              if($enable_logs == 'on'){
              $urlIncludeJS = _MODULE_DIR_.'public/assets/js/jquery.themepunch.enablelog.js?rev='. $slver;
              $htmlBeforeSlider .= '<script type="text/javascript" src="'.$urlIncludeJS.'"></script>';
              }

              $urlIncludeJS = _MODULE_DIR_.'public/assets/js/jquery.themepunch.tools.min.js?rev='. $slver;
              $htmlBeforeSlider .= '<script type="text/javascript" src="'.$urlIncludeJS.'"></script>';
              $urlIncludeJS = _MODULE_DIR_.'public/assets/js/jquery.themepunch.revolution.min.js?rev='. $slver;
              $htmlBeforeSlider .= '<script type="text/javascript" src="'.$urlIncludeJS.'"></script>';
            ...
            if ($sliderType != 'fullscreen') {
                if ($sliderPosition != 'center') {
                    $containerStyle .= 'margin-left:' . ($this->slider->getParam('margin_left', '0', RevSlider::FORCE_NUMERIC)) . 'px;';
                    $containerStyle .= 'margin-right:' . ($this->slider->getParam('margin_right', '0', RevSlider::FORCE_NUMERIC)) . 'px;';
                }

                $containerStyle .= 'margin-top:' . ($this->slider->getParam('margin_top', '0', RevSlider::FORCE_NUMERIC)) . 'px;';
                $containerStyle .= 'margin-bottom:' . ($this->slider->getParam('margin_bottom', '0', RevSlider::FORCE_NUMERIC)) . 'px;';
            }
            ...
            $progress_style = ' style="height: ' . ($progress_height) . 'px; background-color: ' . RevSliderFunctions::hex2rgba($progressbar_color, $progress_opa) . ';"';
            ...
            echo '<!-- START REVOLUTION SLIDER ' . _REV_VERSION_ . ' ' . $sliderType . ' mode -->' . "\n";

            echo '	<div id="' . $this->sliderHtmlID . '"';
            echo ' class="' . $sliderClass . $do_overflow . '"';
            echo ' style="' . $bannerStyle . '"';
            echo ' data-version="' . _REV_VERSION_ . '">' . "\n";
    ...
    private function putJS($markup_export = false)
    {
        ...
        $iqitFrontJsEnd = '';
        if ($this->previewMode != true) {
            $iqitFrontJsStart = 'iqitRevolutionSlider.inlineFunctions.push(function() {';
            $iqitFrontJsEnd = '});';
        }
...
//				$noConflict = $this->slider->getParam("jquery_noconflict","on");
        ...
        $js_to_footer = (@RevsliderPrestashop::getIsset($arrValues['js_to_footer']) && $arrValues['js_to_footer'] == 'on') ? true : false;
        ...
        $csizes = RevSliderFunctions::getResponsiveSize($this);
        ...
        <?php echo $iqitFrontJsStart; if (!$markup_export) { //not needed for html markup export   ?>
                /******************************************
            ...
            ?>');
            <?php if (@RevsliderPrestashop::getIsset($csizes['level']) && !empty($csizes['level'])) {
        ...
        echo 'jsFileLocation:"' . ($stripped_http . 'revsliderprestashop/views/js/rs-plugin/js/') . '",' . "\n";
        ...
        echo '						delay:' . ($this->slider->getParam("delay", "9000", RevSlider::FORCE_NUMERIC)) . ',' . "\n";
...
//no navigation if we are hero
        if ($slider_type !== 'hero' && ($enable_arrows == 'on' || $enable_bullets == 'on' || $enable_tabs == 'on' || $enable_thumbnails == 'on' || $touch_enabled == 'on' || $keyboard_enabled == 'on' || $mousescroll_enabled == 'on')) {
            ...
            if ($enable_arrows == 'on') {
                ...
                if (!empty($all_navs)) {
                    foreach ($all_navs as $cur_nav) {
                        if ($cur_nav['handle'] == $navigation_arrow_style) {
                            ...
                            if (@RevsliderPrestashop::getIsset($cur_nav['css']['arrows'])) {
                ...
                if ($hide_arrows_on_mobile === 'true') {
                    echo '								hide_under:' . ($this->slider->getParam('arrows_under_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                if ($hide_arrows_over === 'true') {
                    echo '								hide_over:' . ($this->slider->getParam('arrows_over_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								hide_onleave:' . $arrows_always_on . ',' . "\n";
                if ($arrows_always_on === 'true') {
                    echo '								hide_delay:' . ($this->slider->getParam('hide_arrows', '200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                    echo '								hide_delay_mobile:' . ($this->slider->getParam('hide_arrows_mobile', '1200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								tmp:\'';
                echo preg_replace("/\r|\n/", "", $arr_tmp);
                echo '\',' . "\n";
                ...
                echo '									h_offset:' . ($this->slider->getParam('leftarrow_offset_hor', '20', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '									v_offset:' . ($this->slider->getParam('leftarrow_offset_vert', '0', RevSlider::FORCE_NUMERIC)) . "\n";
                echo '								},' . "\n";
                echo '								right: {' . "\n";
                ...
                echo '									h_offset:' . ($this->slider->getParam('rightarrow_offset_hor', '20', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '									v_offset:' . ($this->slider->getParam('rightarrow_offset_vert', '0', RevSlider::FORCE_NUMERIC)) . "\n";
                echo '								}' . "\n";
                echo '							}' . "\n";
            }
            ...
            if ($enable_bullets == 'on') {
                ...
                if (!empty($all_navs)) {
                    foreach ($all_navs as $cur_nav) {
                        if ($cur_nav['handle'] == $navigation_bullets_style) {
                            ...
                            if (@RevsliderPrestashop::getIsset($cur_nav['css']['bullets'])) {
                ...
                if ($hide_bullets_on_mobile === 'true') {
                    echo '								hide_under:' . ($this->slider->getParam('bullets_under_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                if ($hide_bullets_over === 'true') {
                    echo '								hide_over:' . ($this->slider->getParam('bullets_over_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								style:"' . ($navigation_bullets_style) . '",' . "\n";
                echo '								hide_onleave:' . $bullets_always_on . ',' . "\n";
                if ($bullets_always_on === 'true') {
                    echo '								hide_delay:' . ($this->slider->getParam('hide_bullets', '200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                    echo '								hide_delay_mobile:' . ($this->slider->getParam('hide_bullets_mobile', '1200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                ...
                echo '								h_offset:' . ($this->slider->getParam('bullets_offset_hor', '20', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								v_offset:' . ($this->slider->getParam('bullets_offset_vert', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								space:' . ($this->slider->getParam('bullets_space', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								tmp:\'';
                echo preg_replace("/\r|\n/", "", $bul_tmp);
                echo '\'' . "\n";
                echo '							}' . "\n";
            ...
            if ($enable_thumbnails == 'on') {
                ...
                if (!empty($all_navs)) {
                    foreach ($all_navs as $cur_nav) {
                        if ($cur_nav['handle'] == $thumbnails_style) {
                            ...
                            if (@RevsliderPrestashop::getIsset($cur_nav['css']['thumbs'])) {
                ...
                echo ',' . "\n";
                echo '								width:' . ($this->slider->getParam('thumb_width', '100', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								height:' . ($this->slider->getParam('thumb_height', '50', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								min_width:' . ($this->slider->getParam('thumb_width_min', '100', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								wrapper_padding:' . ($this->slider->getParam('thumbnails_padding', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                ...
                echo preg_replace("/\r|\n/", "", $thumbs_tmp);
                echo '\',' . "\n";
                echo '								visibleAmount:' . ($this->slider->getParam('thumb_amount', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								hide_onmobile:' . $hide_thumbs_on_mobile . ',' . "\n";
                if ($hide_thumbs_on_mobile === 'true') {
                    echo '								hide_under:' . ($this->slider->getParam('thumbs_under_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                if ($hide_thumbs_over === 'true') {
                    echo '								hide_over:' . ($this->slider->getParam('thumbs_over_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								hide_onleave:' . $thumbs_always_on . ',' . "\n";
                if ($thumbs_always_on === 'true') {
                    echo '								hide_delay:' . ($this->slider->getParam('hide_thumbs', '200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                    echo '								hide_delay_mobile:' . ($this->slider->getParam('hide_thumbs_mobile', '1200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                ...
                echo '								space:' . ($this->slider->getParam('thumbnails_space', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                ...
                echo '								h_offset:' . ($this->slider->getParam('thumbnails_offset_hor', '20', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								v_offset:' . ($this->slider->getParam('thumbnails_offset_vert', '0', RevSlider::FORCE_NUMERIC)) . "\n";
                echo '							}' . "\n";
            }
            if ($enable_tabs == 'on') {
                ...
                if (!empty($all_navs)) {
                    foreach ($all_navs as $cur_nav) {
                        if ($cur_nav['handle'] == $tabs_style) {
                            ...
                            if (@RevsliderPrestashop::getIsset($cur_nav['css']['tabs'])) {
                ...
                echo ',' . "\n";
                echo '								width:' . ($this->slider->getParam('tabs_width', '100', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								height:' . ($this->slider->getParam('tabs_height', '50', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								min_width:' . ($this->slider->getParam('tabs_width_min', '100', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								wrapper_padding:' . ($this->slider->getParam('tabs_padding', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                ...
                echo preg_replace("/\r|\n/", "", $tabs_tmp);
                echo '\',' . "\n";
                echo '								visibleAmount: ' . ($this->slider->getParam('tabs_amount', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								hide_onmobile: ' . $hide_tabs_on_mobile . ',' . "\n";
                if ($hide_tabs_on_mobile === 'true') {
                    echo '								hide_under:' . ($this->slider->getParam('tabs_under_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                if ($hide_tabs_over === 'true') {
                    echo '								hide_over:' . ($this->slider->getParam('tabs_over_hidden', '0', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								hide_onleave:' . $tabs_always_on . ',' . "\n";
                if ($tabs_always_on === 'true') {
                    echo '								hide_delay:' . ($this->slider->getParam('hide_tabs', '200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                    echo '								hide_delay_mobile:' . ($this->slider->getParam('hide_tabs_mobile', '1200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                }
                echo '								hide_delay:' . ($this->slider->getParam('hide_tabs', '200', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                ...
                echo '								space:' . ($this->slider->getParam('tabs_space', '5', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								h_align:"' . ($this->slider->getParam('tabs_align_hor', 'left')) . '",' . "\n";
                echo '								v_align:"' . ($this->slider->getParam('tabs_align_vert', 'center')) . '",' . "\n";
                echo '								h_offset:' . ($this->slider->getParam('tabs_offset_hor', '20', RevSlider::FORCE_NUMERIC)) . ',' . "\n";
                echo '								v_offset:' . ($this->slider->getParam('tabs_offset_vert', '0', RevSlider::FORCE_NUMERIC)) . "\n";
                echo '							}' . "\n";
            }
            echo '						},' . "\n";
        ...
        if (@RevsliderPrestashop::getIsset($csizes['level']) && !empty($csizes['level'])) {
        ...
        if ($this->slider->getParam("custom_javascript", '') !== '') {
           // echo str_replace(array('\"', "\'"), array('"', "'"), Tools::stripslashes($this->slider->getParam("custom_javascript", '')));
           $customJavascript =  str_replace(array('\"', "\'"), array('"', "'"), Tools::stripslashes($this->slider->getParam("custom_javascript", '')));
           echo preg_replace_callback('/revapi(\d+)/', array($this, 'replaceRevapi'), $customJavascript);
        }
        echo '				}' . "\n";
        //echo '			});	/*ready*/' . "\n";
...
//					add_action('wp_footer', array($this, 'addInlineJs'));
        ...
        switch ($use_spinner) {
            ...
            case '4':
                if (!is_admin()) {
                    ...
                    ?><script><?php echo $iqitFrontJsStart; ?>
                        var htmlDivCss = '	#<?php echo $this->sliderHtmlID_wrapper;
        ...
        if ($this->slider->getParam("custom_css", '') !== '') {
            if (!is_admin()) {
                ...
                ?><script>
                <?php echo $iqitFrontJsStart; ?>
                    var htmlDivCss = unescape("<?php echo RevSliderCssParser::compressCss(rawurlencode(Tools::stripslashes($this->slider->getParam('custom_css', ''))));
                ...
                ?><style type="text/css"><?php echo RevSliderCssParser::compressCss(Tools::stripslashes($this->slider->getParam('custom_css', '')));
        ...
        if (trim($nav_css) !== '') {
            if (!is_admin()) {
                ...
                ?><script> <?php echo $iqitFrontJsStart; ?>
                        var htmlDivCss = unescape("<?php echo RevSliderCssParser::compressCss(rawurlencode($nav_css));
                ...
                ?>
                <style type="text/css"><?php echo RevSliderCssParser::compressCss($nav_css);
    ...
    private function replaceRevapi($m){
        return 'revapi'.$this->slider->getID();
    }
