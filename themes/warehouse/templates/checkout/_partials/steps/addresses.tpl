  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><i class="fa fa-plus" aria-hidden="true"></i> {l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><i class="fa fa-plus" aria-hidden="true"></i> {l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
      ...
      {if !$form_has_continue_button}
        <div class="clearfix">
          <button type="submit" class="btn btn-primary continue btn-block btn-lg" name="confirm-addresses" value="1">
