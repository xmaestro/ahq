								...
								<div class="cbp-hrsub-inner">
									...
									<div class="row no-gutters">
										...
										<ul class="cbp-hrsub-tabs-names cbp-tabs-names">
											...
											<div role="tabpanel" class="tab-pane cbp-tab-pane {if $smarty.foreach.innertabscontent.first}active{/if} innertabcontent-{$innertab->id}"  id="{$innertab->id}-innertab-{$tab.id_tab}">
