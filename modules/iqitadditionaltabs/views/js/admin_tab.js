            ...
            success: function (data) {
                if (data.status) {
                    ...
                    if (data.action == 'add'){
                        ...
                        tmplHtml = tmplHtml.replace(new RegExp('::tabTitle::', 'g'), data.tab.title)
                        $iqitadditionaltabList.append(tmplHtml);
                    } else {
                        $('#iqitadditionaltabs_title_' + data.tab.id).text(data.tab.title);
                    }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each( data.tab.description, function( i, val ) {
                    $('#iqitadditionaltabs_description_' + i).val(val);
