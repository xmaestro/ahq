...
class IqitElementorWidget_Brands
{
    ...
    public function getForm()
    {
        ...
        $brandsOptions[0] = IqitElementorWpHelper::__('-- Show all --', 'elementor');
    ...
    public function parseOptions($optionsSource, $preview = false)
    {
        ...
        if ($selectedBrands[0] == 0) {
            ...
            foreach ($allBrands as $brand) {
                ...
                if ($fileExist) {
                    $brands[$brand['id_manufacturer']]['link'] = Context::getContext()->link->getManufacturerLink($brand['id_manufacturer']);
            ...
            foreach ($selectedBrands as $brand) {
                ...
                if ($fileExist) {
                    $brands[$brand]['link'] = Context::getContext()->link->getManufacturerLink($brand);
