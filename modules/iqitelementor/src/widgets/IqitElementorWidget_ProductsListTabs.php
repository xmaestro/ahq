 ...
 */
class IqitElementorWidget_ProductsListTabs
{
    /**
     * @var int
     */
    ...
    {
        $this->name = IqitElementorWpHelper::__('Tabs with products', 'elementor');
        $this->id_base = 'ProductsListTabs';
        $this->icon = 'tabs';
    ...
    public function getForm()
    {
        ...
        if ($this->editMode) {
            $categories = $this->generateCategoriesOption($this->customGetNestedCategories($this->context->shop->id, null, (int)$this->context->language->id, false));
        }
        ...
        return [
            ...
            'tabs' => [
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'slides_to_show',
                        'label' => IqitElementorWpHelper::__('Show per line (desktop)', 'elementor'),
                        'type' => 'select',
                        'default' => '6',
                        'label_block' => true,
                    ...
                    [
                        ...
                        'label' => IqitElementorWpHelper::__('Show per line (tablet)', 'elementor'),
                        'type' => 'select',
                        'default' => '6',
                        'label_block' => true,
                        'options' => $slidesToShow,
                    ...
                    [
                        ...
                        'label' => IqitElementorWpHelper::__('Show per line (phone)', 'elementor'),
                        'type' => 'select',
                        'default' => '6',
                        'label_block' => true,
                        'options' => $slidesToShow,
            ...
            'tabs_position' => [
                'label' => IqitElementorWpHelper::__('Tabs position', 'elementor'),
                'type' => 'select',
                'tab' => 'style',
                'default' => 'left',
            ...
            'tab_color' => [
                'label' => IqitElementorWpHelper::__('Tab color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'section' => 'section_style_tabs',
                'selectors' => [
            ...
            'tab_border_color' => [
                'label' => IqitElementorWpHelper::__('Tab border color', 'elementor'),
                'type' => 'color',
                'tab' => 'style',
                'section' => 'section_style_tabs',
                'selectors' => [
    ...
    public function parseOptions($optionsSource, $preview = false)
    {
        ...
        foreach ($optionsSource['tabs'] as $tab){
            ...
            if ($source == 'ms') {
                ...
                $products = $this->getProducts($source, $tab['products_limit'], $tab['order_by'], $tab['order_way']);
            }
            ...
            if ($tab['view'] == 'grid' || $tab['view'] == 'grid_s'){
                ...
                $parsedTab['options'] = [
                    'slidesToShow' => IqitElementorWpHelper::absint( $tab['slides_to_show'] ),
                    'slidesToScroll' => IqitElementorWpHelper::absint( $tab['slides_to_show'] ),
                    'slidesToShowTablet' => IqitElementorWpHelper::absint( $tab['slides_to_show_tablet'] ),
                    'slidesToShowMobile' => IqitElementorWpHelper::absint( $tab['slides_to_show_mobile']),
                    'itemsPerColumn' => IqitElementorWpHelper::absint( $tab['items_per_column']),
        ...
        if ($preview){
            ...
            if (isset($result['iqitthemeeditor'])){
                $parsedOptions['iqitTheme'] = $result['iqitthemeeditor'];
            }
        }
    ...
    public function getProducts($source, $limit, $orderBy, $orderWay)
    {
