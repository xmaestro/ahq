<?php /* Smarty version Smarty-3.1.19, created on 2017-10-05 22:10:36
         compiled from "/opt/lampp/apps/prestashop/htdocs/administration/themes/default/template/controllers/themes/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151373057259d691bc7555c4-85834262%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b55f10bd4be151727bf27c036922075009e22080' => 
    array (
      0 => '/opt/lampp/apps/prestashop/htdocs/administration/themes/default/template/controllers/themes/helpers/options/options.tpl',
      1 => 1503928274,
      2 => 'file',
    ),
    '7aecedc9001cf243db32cf7147f3357b9c2fe7e0' => 
    array (
      0 => '/opt/lampp/apps/prestashop/htdocs/administration/themes/default/template/helpers/options/options.tpl',
      1 => 1503928274,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151373057259d691bc7555c4-85834262',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d691bcd4b919_06842326',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d691bcd4b919_06842326')) {function content_59d691bcd4b919_06842326($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/opt/lampp/apps/prestashop/htdocs/vendor/prestashop/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/apps/prestashop/htdocs/vendor/prestashop/smarty/plugins/modifier.replace.php';
?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Options','d'=>'Admin.Global'),$_smarty_tpl);?>
<?php }?>
			</div>
...
_multishop_<?php echo $_smarty_tpl->tpl_vars['category']->value;?>
_on"><?php echo smartyTranslate(array('s'=>'Yes','d'=>'Admin.Global'),$_smarty_tpl);?>
...
_multishop_<?php echo $_smarty_tpl->tpl_vars['category']->value;?>
_off"><?php echo smartyTranslate(array('s'=>'No','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
								...
								<div class="thumbnail-wrapper">
									<div class="action-wrapper">
										...
										<div class="action-buttons">
											<div class="btn-group">
												<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminThemes'),'html','UTF-8');?>
...
" title="<?php echo smartyTranslate(array('s'=>'Delete this theme'),$_smarty_tpl);?>
" class="delete">
...
<?php echo $_smarty_tpl->tpl_vars['theme']->value->get('preview');?>
...
_on" class="radioCheck"><?php echo smartyTranslate(array('s'=>'Yes','d'=>'Admin.Global'),$_smarty_tpl);?>
...
<?php }?><?php if (isset($_smarty_tpl->tpl_vars['field']->value['disabled'])&&(bool)$_smarty_tpl->tpl_vars['field']->value['disabled']) {?> disabled="disabled"<?php }?>/><label for="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
_off" class="radioCheck"><?php echo smartyTranslate(array('s'=>'No','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
												<a class="slide-button btn"></a>
											</span>
										</div>
...
" value="<?php if (isset($_smarty_tpl->tpl_vars['field']->value['no_escape'])&&$_smarty_tpl->tpl_vars['field']->value['no_escape']) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['field']->value['value'],'UTF-8');?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['field']->value['value'],'html','UTF-8');?>
...
<?php }?>" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['field']->value['value'],'html','UTF-8');?>
" />
											</div>
							            </div>
...
<?php } else { ?>5<?php }?>" name="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['field']->value['value'],'html','UTF-8');?>
" />
											</div>
										</div>
...
"
																value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['value']->value,'html','UTF-8');?>
"
...
" class="_blank">
					<img class="center-block img-thumbnail" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getBaseLink();?>
<?php echo $_smarty_tpl->tpl_vars['cur_theme']->value->get('preview');?>
...
" />
 ...
 <small>version <?php echo $_smarty_tpl->tpl_vars['cur_theme']->value->get('version');?>
				...
				<p>
					<?php echo smartyTranslate(array('s'=>'Designed by %s','sprintf'=>array($_smarty_tpl->tpl_vars['cur_theme']->value->get('author.name'))),$_smarty_tpl);?>

				</p>

				<hr />
				<h4><?php echo smartyTranslate(array('s'=>'Configure your page layouts'),$_smarty_tpl);?>
</h4>
				<div class="row">
					<div class="col-sm-8">
						<p><?php echo smartyTranslate(array('s'=>'Each page can use a different layout, choose it among the layouts bundled in your theme.'),$_smarty_tpl);?>
</p>
					</div>
...
">
								<?php echo smartyTranslate(array('s'=>'Reset to defaults'),$_smarty_tpl);?>
...
?>
						<?php if (isset($_smarty_tpl->tpl_vars['btn']->value['href'])&&trim($_smarty_tpl->tpl_vars['btn']->value['href'])!='') {?>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['btn']->value['href'],'html','UTF-8');?>
