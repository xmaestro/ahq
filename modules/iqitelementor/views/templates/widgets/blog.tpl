        ...
        <section class="elementor-blog-posts elementor-blog-posts-carousel elementor-slick-slider ph_simpleblog">
            <div class="elementor-blog-carousel simpleblog-posts {$classes}" data-slider_options='{$options|@json_encode nofilter}'>
                {foreach $posts as $post}
                    <div class="simpleblog-posts-column">{include file="module:ph_simpleblog/views/templates/front/post-miniature.tpl" post=$post}</div>
                {/foreach}
            </div>
        </section>
    {elseif $view == 'grid'}
        <section class="elementor-blog-posts elementor-blog-posts-grid ph_simpleblog">
            <div class="row simpleblog-posts">
                {foreach $posts as $post}
                    <div class="simpleblog-posts-column {$options.gridClasses}">{include file="module:ph_simpleblog/views/templates/front/post-miniature.tpl" post=$post}</div>
                {/foreach}
            </div>
        </section>
    {elseif $view == 'list'}
