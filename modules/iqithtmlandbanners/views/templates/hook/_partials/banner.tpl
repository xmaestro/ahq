...
{else}
    <div id="iqithtmlandbanners-block-{$block.id}" class="iqithtmlandbanners-block iqithtmlandbanners-block-banner iqithtmlandbanners-block-banner-slider js-iqithtmlandbanners-block-banner-slider mb-4">
        {foreach from=$block.content.banners item=banner}
            <div>
            {if $banner.link != ''}<a href="{$banner.link}">{/if}
