...
class AdminSimpleBlogPostsController extends ModuleAdminController
{
    ...
    public function createFeatured($img = null, $object = null)
    {
        ...
        if(isset($object) && Validate::isLoadedObject($object))
        {
            ...
            // Create thumb
            ImageManager::thumbnail(_PS_MODULE_DIR_ . 'ph_simpleblog/featured/'.$object->id.'.'.$object->featured, 'ph_simpleblog_featured_'.$object->id.'.'.$object->featured, 350, $object->featured);
           
            return true;
        }
        else
        {
            die('AdminSimpleBlogPostsController@createFeatured: Unable to load object');
        }
