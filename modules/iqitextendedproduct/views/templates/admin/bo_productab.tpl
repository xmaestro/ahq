...
<div id="iqitvideos-container" class="clearfix m-b-2">
    <div class="form-inline m-b-1">
        <fieldset class="form-group">
            <label>{l s='YouTube/Vimeo/Dailymotion link' mod='iqitextendedproduct'}</label>
    ...
    <div id="iqitvideos-list" class="iqitvideos-list col-md-12">

        {foreach $productVideoContent as $video}
            <div class="iqitvideo-preview js-iqitvideo-preview col-xs-3" data-video-url="{$video.id}" data-video-provider="{$video.p}">
                <div class="vcontent">
                    <div class="info clearfix">
                        <span><i class="material-icons">drag_handle</i></span>
                        <button type="button" class="btn btn-danger-outline btn-sm pull-xs-right js-delete-video"><i
...
<div id="iqitvideo-previewsample">
    <div class="iqitvideo-preview js-iqitvideo-preview col-xs-3" data-video-url="" data-video-provider="">
        <div class="vcontent">
            <div class="info clearfix">
                <span><i class="material-icons">drag_handle</i></span>
                <button type="button" class="btn btn-danger-outline btn-sm pull-xs-right js-delete-video"><i
        ...
        {foreach $threeSixtyContent as $image}
            <div class="dz-preview dz-processing dz-image-preview dz-complete ui-sortable-handle"
                ...
                <div class="dz-image bg"
                     style="background-image: url('{$path}uploads/threesixty/{$product}/{$image.n}');"></div>
